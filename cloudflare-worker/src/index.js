...
async function admin(request, env) {
  ...
  switch (cerere.actiune) {
    ...
    case 'anunt': {
      ...
      // [v15.9] `doarAnunt` = scrie-l, dar nu trimite notificări. Panoul are
      // acum un singur formular, în care alegi calea: notificare pe telefon,
      // anunț în aplicație, sau amândouă. Fără asta, orice anunț ar suna la
      // toată lumea, chiar dacă n-ai cerut.
      if (cerere.doarAnunt) {
        return { status: 200, corp: { ok: true, trimise: null } };
      }
